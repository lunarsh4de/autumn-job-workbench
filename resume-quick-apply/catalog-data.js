...
(() => {
  ...
  const JOB_TYPE_RULES = [
    ...
    ['销售客户', ['销售', '客户成功', '客户经理', '商务', '售前', '售后', '渠道', '采购', 'account rep', 'account manager', 'customer success', 'business development', 'sales']],
    ['职能管培', ['管培', '人力', '招聘', '行政', '文员', '物业', '前台', '接待', '财务', '审计', '法务', '合规', '秘书', '翻译', '党建', 'management trainee', 'human resources', 'finance', 'administration']],
    ['供应链制造', ['供应链', '物流', '计划', '生产', '制造', '质量', '工艺', '机械', '汽车', '采购工程', '原料开发', '材料', '检验员', '检测员', '巡检', '运行值班', '发电运行', 'production', 'manufacturing', 'quality', 'process']],
