...
(() => {
  ...
  const JOB_TYPE_RULES = [
    ['数据算法', ['算法', '数据科学', '数据分析', '数据开发', '大数据', '机器学习', '深度学习', '人工智能', 'nlp', '商业分析', '数仓', 'data scientist', 'data analyst', 'data engineer', 'machine learning']],
    ['技术研发', ['开发工程师', '软件工程', '前端', '后端', '客户端', '移动端', '测试工程', '运维', '研发', '嵌入式', '硬件', '芯片', 'web', 'java', 'c++', 'golang', 'python', '软件', 'software', 'engineer', 'engineering', 'developer', 'development', 'technical', 'system', 'circuit', 'verification', '自动驾驶', 'autonomous', '实施工程', '技术支持', '支持工程', '工程师', '技术员', '设计研发', '控制系统']],
    ['产品项目', ['产品经理', '产品运营', '产品设计', '项目经理', '项目管理', '解决方案', '需求分析', '策划', 'product manager', 'product operations', 'product', 'project manager', 'game design', 'planning']],
    ['设计体验', ['设计师', '视觉设计', '交互设计', '用户体验', 'ui设计', 'ux设计', '工业设计', '内容设计', '原画', '动画', '美术', '场景', '编导', '视频设计', '游戏动作', '走秀']],
    ['运营市场', ['运营', '市场', '品牌', '公关', '新媒体', '内容', '增长', '活动策划', '广告', 'operations', 'marketing', 'user growth', 'growth intern', '培训']],
    ['销售客户', ['销售', '客户成功', '客户经理', '客户服务', '商务', '售前', '售后', '渠道', '采购', '跟单', '置业顾问', '经纪人', '计调', '咨询助理', '高净值客户', 'account rep', 'account manager', 'customer success', 'business development', 'sales']],
    ['职能管培', ['管培', '人力', '招聘', '行政', '文员', '物业', '前台', '接待', '财务', '审计', '法务', '合规', '秘书', '翻译', '党建', 'management trainee', 'human resources', 'finance', 'administration']],
    ['供应链制造', ['供应链', '物流', '计划', '生产', '制造', '质量', '工艺', '机械', '汽车', '采购工程', '原料开发', '材料', '检验员', '检测员', '巡检', '运行值班', '发电运行', '施工员', '测绘', '造价', '预决算', '数控', 'cnc', '普工', '抽样员', '安全员', '工程成本', '电力工程', 'production', 'manufacturing', 'quality', 'process']],
    ['金融法务', ['投资', '证券', '银行', '保险', '信贷', '风控', '风险管理', '消费者权益', '金融', '法务', '法律']],
    ['教育医疗', ['教师', '教育', '课程', '医疗', '医生', '护士', '药学', '临床', '医药', '动物实验', '分子实验', '实验员', '生物实验']],
  ];
  const TAG_FALLBACK_TYPES = {
    '数据/算法': '数据算法',
    '技术/IT': '技术研发',
    '运营/市场': '运营市场',
    '销售/客户': '销售客户',
  ...
  const CITY_PROVINCES = {
    北京: '北京', 上海: '上海', 天津: '天津', 重庆: '重庆', 广州: '广东', 深圳: '广东', 珠海: '广东', 佛山: '广东', 东莞: '广东', 汕尾: '广东', 汕头: '广东', 惠州: '广东', 中山: '广东', 江门: '广东', 湛江: '广东', 茂名: '广东', 肇庆: '广东', 清远: '广东', 潮州: '广东', 揭阳: '广东', 杭州: '浙江', 宁波: '浙江', 温州: '浙江', 嘉兴: '浙江', 湖州: '浙江', 绍兴: '浙江', 金华: '浙江', 衢州: '浙江', 舟山: '浙江', 台州: '浙江', 丽水: '浙江', 南京: '江苏', 苏州: '江苏', 无锡: '江苏', 徐州: '江苏', 常州: '江苏', 南通: '江苏', 连云港: '江苏', 淮安: '江苏', 盐城: '江苏', 扬州: '江苏', 镇江: '江苏', 泰州: '江苏', 宿迁: '江苏', 成都: '四川', 绵阳: '四川', 德阳: '四川', 泸州: '四川', 乐山: '四川', 南充: '四川', 宜宾: '四川', 西昌: '四川', 武汉: '湖北', 黄石: '湖北', 宜昌: '湖北', 襄阳: '湖北', 长沙: '湖南', 株洲: '湖南', 岳阳: '湖南', 郑州: '河南', 开封: '河南', 洛阳: '河南', 新乡: '河南', 许昌: '河南', 南阳: '河南', 西安: '陕西', 宝鸡: '陕西', 咸阳: '陕西', 渭南: '陕西', 合肥: '安徽', 芜湖: '安徽', 福州: '福建', 厦门: '福建', 泉州: '福建', 济南: '山东', 青岛: '山东', 济宁: '山东', 日照: '山东', 威海: '山东', 临沂: '山东', 淄博: '山东', 烟台: '山东', 沈阳: '辽宁', 大连: '辽宁', 锦州: '辽宁', 铁岭: '辽宁', 葫芦岛: '辽宁', 哈尔滨: '黑龙江', 齐齐哈尔: '黑龙江', 大庆: '黑龙江', 长春: '吉林', 吉林: '吉林', 南昌: '江西', 新余: '江西', 九江: '江西', 赣州: '江西', 昆明: '云南', 曲靖: '云南', 贵阳: '贵州', 遵义: '贵州', 太原: '山西', 大同: '山西', 运城: '山西', 石家庄: '河北', 廊坊: '河北', 保定: '河北', 唐山: '河北', 乌鲁木齐: '新疆', 吐鲁番: '新疆', 巴音郭楞: '新疆', 克拉玛依: '新疆', 兰州: '甘肃', 海口: '海南', 三亚: '海南', 儋州: '海南', 陵水: '海南', 南宁: '广西', 柳州: '广西', 桂林: '广西', 呼和浩特: '内蒙古', 包头: '内蒙古', 鄂尔多斯: '内蒙古', 拉萨: '西藏', 银川: '宁夏', 西宁: '青海', 香港: '香港', 澳门: '澳门', 台北: '台湾'
  };
  ...
  function classifyJobType(value = {}) {
    ...
    const tagText = (Array.isArray(value.tags) ? value.tags : [value.tags]).filter(Boolean).join(' ').toLowerCase();
    for (const [marker, type] of Object.entries(TAG_FALLBACK_TYPES)) {
      if (tagText.includes(marker.toLowerCase())) return type;
    }
    if (tagText.includes('产品/设计')) {
      const designMarkers = ['设计', '原画', '动画', '美术', '场景', '角色', '视频', '编导', '动作', 'ui', 'ux', '视觉', '3d'];
      return designMarkers.some(marker => haystack.includes(marker)) ? '设计体验' : '产品项目';
    }
    return '其他校招';
  }
  ...
  function normalizeCompanyType(value, company = '', location = '') {
    ...
    const foreign = FOREIGN_COMPANY_TYPES.has(explicit) || explicit.includes('外企') || explicit.includes('外资');
    if (foreign) return mainland ? '外企（中国大陆）' : '外企（其他地区）';
    ...
    if (!explicit && FOREIGN_COMPANY_PATTERN.test(company)) return mainland ? '外企（中国大陆）' : '外企（其他地区）';
